...
#SBATCH --job-name=merging_9192            #This is the name of your job
#SBATCH --cpus-per-task=16                  #This is the number of cores reserved
#SBATCH --mem-per-cpu=10G              #This is the memory reserved per core.


#SBATCH --time=03:00:00        #This is the time that your task will run #1-00:00:00
#SBATCH --qos=6hours	           #You will run in this queue #1day
#SBATCH --array=1-45        #This is an array job with 200 tasks with a maximum simultaneous number of 20 tasks
...
$(head -$SLURM_ARRAY_TASK_ID commands_9192.cmd | tail -1) 