...
#SBATCH --job-name=rerun_munits            #This is the name of your job
...
#SBATCH --array=1-30          #1-200%20: This is an array job with 200 tasks with a maximum simultaneous number of 20 tasks
...
$(head -$SLURM_ARRAY_TASK_ID commands_rerun.cmd | tail -1) 