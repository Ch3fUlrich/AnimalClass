...
#SBATCH --job-name=pop_act_stat_big              #This is the name of your job
...
#SBATCH --array=1-5                   #1-200%20: This is an array job with 200 tasks with a maximum simultaneous number of 20 tasks
