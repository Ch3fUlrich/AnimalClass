...
#SBATCH --job-name=pop_act_stat_mov              #This is the name of your job
...
#SBATCH --array=1-66                   #1-200%20: This is an array job with 200 tasks with a maximum simultaneous number of 20 tasks

# Paths to STDOUT or STDERR files should be absolute or relative to current working directory
#SBATCH --output=outputs/intrinsic_pop_act2_%j_%A_%a.o       #These are the STDOUT and STDERR files #j for jobID
#SBATCH --error=outputs/intrinsic_pop_act2_%j_%A_%a.e
...
$(head -$SLURM_ARRAY_TASK_ID commands_population_activity2.cmd | tail -1) 
