...
#SBATCH --cpus-per-task=6                  #This is the number of cores reserved
#SBATCH --mem-per-cpu=3G              #This is the memory reserved per core.

#SBATCH --time=00:05:00         #This is the time that your task will run 01:00:00 or 1-00:00:00
#SBATCH --qos=30min          #You will run in this queue 6hours or 1day  or 1week
#SBATCH --array=1-664          #1-200%20: This is an array job with 200 tasks with a maximum simultaneous number of 20 tasks
...
$(head -$SLURM_ARRAY_TASK_ID commands_create_is_wheel.cmd | tail -1) 